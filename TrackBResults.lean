...
native JSON-shaped results.  Unsafe and global results must pass their native
checkers before output; a bounded-safe result instead remains bound to the
exact proof-bearing reachability outcome that generated it.
-/
